 ...
 * @author fengtao.xue
 */
public class FShiroFilter extends BasicHttpAuthenticationFilter {
    static Logger logger = LoggerFactory.getLogger(FShiroFilter.class);
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response)  {
        ...
        FToken token = new FToken(authKey);
